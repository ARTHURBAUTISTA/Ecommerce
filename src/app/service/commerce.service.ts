...
public BuscarProduct(id){
  
 return this.Products.find((producto)=>producto.productId==id)
    
}

public buscarHeroes(termino:string){
  termino=termino.toLowerCase();
  return this.Products.filter((producto)=>producto.productName.toLowerCase().indexOf(termino)>-1);
}
}
